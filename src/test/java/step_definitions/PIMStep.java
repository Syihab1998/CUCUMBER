...
public class PIMStep {
	...
	@When("^input \"(.*)\" as unameEmploy & input \"(.*)\" as passEmploy & input \"(.*)\" as rePassEmploy & click save btn & click edit btn$")
	...
	@When("input \"(.*)\" as SIMNumb & click genderChckBox & select nationality & input \"(.*)\" as otherID & input \"(.*)\" as SIMExpDate & select marital status & input \"(.*)\" as BirthDate & click save btn")
...
//search
	...
	@When("User input \"(.*)\" as fullName & click search btn")
	...
	public void successfulGetEmployee() throws Throwable {
		allPage AllPage = new allPage(driver);
		Assert.assertTrue(AllPage.getResultNameAct());
